...
This folder is the English operational docset for dataconv-api.

Core guides:

- [Integrator guide](../../INTEGRATORS_GUIDE.md)
- [API development guide](API_DEVELOPMENT_GUIDE.md)
- [00 - Operating modes](00-operating-modes.md)
- [01 - Installation](01-installation.md)
- [02 - Clinic configuration](02-clinic-configuration.md)
- [03 - Run and examples](03-run-and-examples.md)
- [04 - Gateway delivery](04-gateway-delivery.md)
- [05 - Troubleshooting](05-troubleshooting.md)
- [06 - Quick script for IT](06-quick-script-for-it.md)
- [07 - Clinical LOINC mapping](07-clinical-loinc-mapping.md)
- [08 - Multi-tenant API configuration](08-multi-tenant-api-configuration.md)
- [09 - Storage and job queue adapters](09-storage-and-job-queue-adapters.md)
- [10 - Quick GKE deployment](10-quick-gke-deployment.md)
